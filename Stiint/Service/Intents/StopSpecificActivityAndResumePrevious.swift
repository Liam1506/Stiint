//
//  StopSpecificActivityAndResumePrevious.swift
//  Pattrn
//
...
struct StopSpecificActivityAndResumePrevious: LiveActivityIntent {
    static var title: LocalizedStringResource = "Stop the current activity and resume the previous activity"
